...
export class ListaParticipantesPage implements OnInit {
  ...
  public get participantesVerdes(){
    return this.participantes.filter(proc => proc.Estado === true);
  }

  public get participantesRojos(){
    return this.participantes.filter(proc => proc.Estado === false);
  }
